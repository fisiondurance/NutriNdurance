# TFM — Sistema inteligente de planificación nutricional y recomendación intra-entreno para deportistas de resistencia
...
## Programa académico
Máster de Formación Permanente en Inteligencia Artificial Aplicada al Deporte — Universidad Europea.

## Tutor
Joel. Ha validado la propuesta y ha confirmado que el valor del proyecto está en la arquitectura de los módulos, la integración de la evidencia científica y el despliegue final, no solo en el ML.
...
### Justificación
No existe un dataset público de planificación nutricional deportiva individualizada. Las reglas fisiológicas están bien documentadas en la literatura. Se genera un dataset sintético fundamentado en esas reglas, con variabilidad controlada para simular la dispersión real entre deportistas. Se declara y justifica en el TFM.
...
- Comparativa ML vs. baseline de reglas (el contenido más valioso para el TFM)

---

## 8. Visualización y dashboard (Plotly en Streamlit)

Aplicando los principios del módulo 4 del máster (diseño de dashboards, KPIs, interactividad).
...
| 9 | Redacción + defensa | Documento TFM, presentación, demo |

---

---

## 13. Estructura del documento TFM

Estructura obligatoria del máster (30-40 páginas sin contar anexos ni bibliografía):

1. Portada
2. Resumen y palabras clave
3. Índice
4. Introducción y contextualización
5. Justificación del proyecto
6. Objetivos
7. Desarrollo práctico del proyecto
8. Recursos, herramientas, fases y decisiones adoptadas
9. Conclusiones
10. Referencias bibliográficas
11. Anexos (si aplica)

**Formato:** Arial 12, interlineado 1.5, texto justificado, APA 7.ª edición.

---

## 14. Referencias científicas de base

Estas son las fuentes que fundamentan las reglas del sistema. Deben citarse en el TFM:
...
**Nota:** NO inventar referencias. Buscar y citar las fuentes reales cuando se redacte cada apartado del TFM.

---

## 15. Líneas futuras declaradas

### Funcionales
- Prueba piloto con deportistas y profesionales
- Integración con APIs de Strava, Garmin Connect, TrainingPeaks
- Safety rails clínicas (límites duros configurable)
...
4. **Dataset sintético declarado.** Justificado como legítimo académicamente cuando se declara y fundamenta. No se presenta como datos reales.
5. **Motor dual reglas + ML.** El ML no sustituye las reglas; las complementa. La comparativa reglas vs. ML es contenido analítico para el TFM.
...
8. **Plotly para dashboards.** Coherente con el módulo 4 del máster y con Streamlit.
...
12. **Strava en tercer nivel.** API pública y viable, pero no es núcleo del TFM.
13. **Sin prueba piloto.** Eliminada del alcance, pasa a líneas futuras.
14. **Priorización en tres niveles.** Núcleo → segundo nivel → tercer nivel. Permite entregar un TFM sólido aunque no dé tiempo a todo.
...
## 18. Contexto del tutor

Joel ha validado explícitamente:
- La propuesta de nutrición con 4 módulos
- El uso de datos sintéticos fundamentados en la literatura
- Que el valor está en la arquitectura completa, no solo en el ML
- Sugerencias de escalabilidad (Git, FastAPI, PostgreSQL, React/Vue, Docker) como ideas para el futuro, no como requisitos del TFM
